...
export default function About() {
  ...
  return (
    ...
    >
      ...
      {/* Technology and Business Section */}
      <div className="relative z-10 min-h-[60vh] mb-32">
        <div className="container mx-auto px-6">
          <motion.div
          ...
          >
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              <motion.div 
                ...
                className="backdrop-blur-lg bg-white/5 rounded-xl p-6"
              >
                <span className="text-3xl text-white mb-2 block">AI</span>
                <span className="text-white/70">Machine Learning & Neural Networks</span>
              </motion.div>
              <motion.div 
                whileHover={{ scale: 1.05 }}
                className="backdrop-blur-lg bg-white/5 rounded-xl p-6"
              >
                <span className="text-3xl text-white mb-2 block">ML</span>
                <span className="text-white/70">Data Analysis & Modeling</span>
              </motion.div>
              <motion.div 
                whileHover={{ scale: 1.05 }}
                className="backdrop-blur-lg bg-white/5 rounded-xl p-6"
              >
                <span className="text-3xl text-white mb-2 block">Web3</span>
                <span className="text-white/70">Blockchain & DApps</span>
              </motion.div>
              <motion.div 
                whileHover={{ scale: 1.05 }}
                className="backdrop-blur-lg bg-white/5 rounded-xl p-6"
              >
                <span className="text-3xl text-white mb-2 block">Finance</span>
                <span className="text-white/70">Market Analysis & Trading</span>
              </motion.div>
            </div>
          </motion.div>
        </div>
