...
export default function About() {
  ...
  return (
    ...
    >
      ...
      {/* Create a gradient transition at the bottom */}
      <div className="absolute bottom-0 left-0 right-0 h-64 bg-gradient-to-b from-transparent to-gray-950 z-20"></div>
      </motion.main>
      
      {/* Content Section with Resume */}
      <div className="relative bg-gray-950 z-10 -mt-32">
        <ContentSection />
      </div>
    </>
  )
