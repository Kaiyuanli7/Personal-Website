            ...
            <div className="flex flex-col lg:flex-row gap-16">
              ...
              >
                <motion.div 
                  ...
                  style={{ boxShadow }}
                >
                  <h2 className="text-3xl font-bold text-white mb-8 font-display">Send a Message</h2>
              ...
              >
                <div className="space-y-8">
                  <motion.div 
                    ...
                    style={{ boxShadow }}
                  >
                    <h2 className="text-3xl font-bold text-white mb-6 font-display">Contact Info</h2>
