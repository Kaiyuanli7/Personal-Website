        ...
        {isOpen && (
          ...
          >
            ...
            <div className="p-4 space-y-5">
              ...
              {/* Cursor Color Selection - Always visible */}
              <div>
                <p className="text-white text-sm mb-3">Cursor Color</p>
                  ...
                  {(Object.keys(CURSOR_COLORS) as CursorColorType[]).map((color) => (
                    <button
                      ...
                      onClick={() => {
                        ...
                        // Briefly close and reopen to force a refresh
                        setIsOpen(false);
                ...
                <div className="mt-2 flex items-center">
                  <div className="text-white/50 text-xs">
                    Current: <span className="text-white">{colorNames[cursorColor]}</span>
                  </div>
                </div>
              </div>
            </div>
