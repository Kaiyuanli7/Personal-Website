        ...
        <CardItem translateZ="100" className="w-full">
          <div className="bg-black/80 w-full rounded-xl p-4 h-[220px] overflow-hidden border border-white/10">
            ...
            <div className="text-blue-400 font-mono text-sm">
              ...
              <div className="ml-4 mb-1">
                <span className="text-green-400">hobbies</span>: [<span className="text-yellow-300">'JS'</span>, <span className="text-yellow-300">'Python'</span>, <span className="text-yellow-300">'Java'</span>]
              </div>
              <div>
                {"}"};
              </div>
