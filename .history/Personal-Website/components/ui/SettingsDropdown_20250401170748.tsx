      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute right-full top-1/2 -translate-y-1/2 mr-2 w-64 bg-gray-950/90 backdrop-blur-sm border border-white/10 rounded-lg shadow-lg z-50 overflow-hidden"
          >
