            ...
            <div className="p-4 space-y-3">
              <div className="flex items-center justify-between">
                ...
                <button 
                  ...
                  className="relative inline-flex h-6 w-11 items-center rounded-full cursor-hover"
                ...
                >
                  ...
                  <span
                    className={`${
                      cursorEnabled ? 'bg-white' : 'bg-white/30'
                    } inline-block h-4 w-9 rounded-full transition`}
                  />
                  <span
                    className={`${
                      cursorEnabled ? 'translate-x-6 bg-gray-950' : 'translate-x-1 bg-white/50'
