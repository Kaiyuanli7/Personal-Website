  ...
  return (
    ...
    >
      <div style={{ height: `calc(${SECTION_HEIGHT}px + 100vh)` }} className="relative w-full">
        ...
        {/* Hero Content */}
        <div className="relative z-10 flex flex-col items-center justify-center min-h-screen [perspective:1000px]">
          <motion.h1
            initial={{ opacity: 0, rotateX: 90, rotateY: 45, y: 100, scale: 0.5 }}
          ...
          >
            <Link
              href="/projects"
              className="inline-block bg-white/10 hover:bg-white/20 text-white font-medium py-3 px-6 rounded-lg transition-colors backdrop-blur-sm"
            >
              View Projects
            </Link>
          </motion.div>
