          ...
          <div className="sticky top-0 py-24 flex items-center justify-center min-h-screen">
            <div className="container-custom w-full max-w-6xl relative">
              ...
              */}
              ...
              {/* 
                What I Do Section
                - Appears between scroll progress 0.5-0.6
                - Stays visible until 0.8-0.9
                - Current animation sequence:
                  0.5-0.6: Fade in and slide up
                  0.6-0.7: Rotate into position
                  0.7-0.75: Stay stable
                  0.75-0.8: Rotate out
                  0.8-0.9: Fade out and slide up
              */}
              <motion.div 
                className="relative -mt-32 rounded-2xl overflow-hidden backdrop-blur-lg border border-white/10"
                style={{ 
                  opacity: useTransform(aboutMeProgress, [0.5, 0.6, 0.8, 0.9], [0, 1, 1, 0]),
                  y: useTransform(aboutMeProgress, [0.5, 0.6, 0.8, 0.9], [100, 0, 0, -50]),
                  scale: useTransform(aboutMeProgress, [0.5, 0.55, 0.75, 0.8], [0.9, 1, 1, 0.9]),
                  rotateX: useTransform(aboutMeProgress, [0.5, 0.6, 0.7, 0.8], [10, 0, 0, -10])
                }}
              >
                ...
                <div className="grid md:grid-cols-[1fr_2fr] gap-6 p-8 relative z-10">
                  <div className="flex flex-col justify-center items-center md:items-end">
                    <motion.div 
                      ...
                      style={{
                        rotate: useTransform(aboutMeProgress, [0.55, 0.8], [-5, 5]),
                      }}
                    >
                      <div className="w-full h-full rounded-full bg-gray-900 flex items-center justify-center overflow-hidden">
                        <motion.div 
                          ...
                          style={{
                            scale: useTransform(aboutMeProgress, [0.6, 0.7], [0.9, 1]),
                          }}
                        >
                          WD
                        </motion.div>
                    ...
                    <motion.h3 
                      className="text-4xl font-bold text-white mt-6 font-display text-center md:text-right"
                      style={{
                        y: useTransform(aboutMeProgress, [0.55, 0.65], [20, 0]),
                        opacity: useTransform(aboutMeProgress, [0.55, 0.65], [0, 1]),
                      }}
                    >
                      What I Do
                    </motion.h3>
                  ...
                  <div className="space-y-6">
                    <motion.div 
                      className="overflow-hidden rounded-xl bg-white/5 backdrop-blur-sm p-5 border border-white/10"
                      style={{
                        y: useTransform(aboutMeProgress, [0.55, 0.65], [30, 0]),
                        opacity: useTransform(aboutMeProgress, [0.55, 0.65], [0, 1]),
                        rotateY: useTransform(aboutMeProgress, [0.6, 0.7, 0.8], [-5, 0, 5]),
                      }}
                    >
                    ...
                    <motion.div 
                      className="overflow-hidden rounded-xl bg-white/5 backdrop-blur-sm p-5 border border-white/10"
                      style={{
                        y: useTransform(aboutMeProgress, [0.65, 0.75], [30, 0]),
                        opacity: useTransform(aboutMeProgress, [0.65, 0.75], [0, 1]),
                        rotateY: useTransform(aboutMeProgress, [0.7, 0.8], [5, -5]),
                      }}
                    >
