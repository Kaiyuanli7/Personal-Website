...
export default function ContentSection() {
  ...
  return (
    <section ref={sectionRef} className="relative pt-40 pb-48">
      {/* Add a gradient overlay for smooth transition */}
      <div className="absolute inset-0 bg-gradient-to-b from-gray-950 via-gray-950/80 to-white top-[-100px] h-[calc(100%+100px)]" />
      <div className="absolute inset-0 bg-white rounded-[50px] top-20">
