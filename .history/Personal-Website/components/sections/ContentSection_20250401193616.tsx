...
export default function ContentSection() {
  ...
  return (
    <section ref={sectionRef} className="relative pt-12 pb-48">
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-gray-950 via-gray-950/50 to-[#1E67C6]" />
      <div className="absolute inset-0 bg-gradient-to-b from-[#1E67C6] to-[#87CEEB] rounded-[50px]">
