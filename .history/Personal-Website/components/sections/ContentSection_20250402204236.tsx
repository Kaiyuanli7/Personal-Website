            ...
            <div className="container-custom w-full max-w-6xl relative">
              ...
              */}
              ...
              {/* 
                ...
                - First dot fades out at 0.5
                - Second dot fades in at 0.5
              ...
              */}
              <motion.div 
                ...
                style={{ 
                  opacity: useTransform(aboutMeProgress, [0.1, 0.2, 0.8, 0.9], [0, 1, 1, 0])
                }}
              >
                <motion.div 
                  className="w-10 h-2 rounded-full bg-white"
                  style={{ 
                    opacity: useTransform(aboutMeProgress, [0, 0.5], [1, 0.3]) 
                  }}
                />
                <motion.div 
                  className="w-10 h-2 rounded-full bg-white"
                  style={{ 
                    opacity: useTransform(aboutMeProgress, [0.5, 0.9], [0.3, 1]) 
                  }}
                />
              </motion.div>
            </div>
