  ...
  return (
    <section ref={sectionRef} className="relative pt-0 pb-48 bg-gray-950">
      <div className="container-custom relative">
        ...
        <div ref={introBannerRef} id="intro-banner" className="min-h-screen mb-32">
        ...
        {/* About Me Section */}
        <div ref={aboutMeRef} id="about-me" className="relative min-h-[1000vh] mb-32">
          <div className="sticky top-0 py-24 flex items-center justify-center min-h-screen">
        ...
        {/* What I Do Section */}
        <div ref={whatIDoRef} id="what-i-do" className="relative min-h-[1000vh] mb-32">
          <div className="sticky top-0 py-24 flex items-center justify-center min-h-screen">
            <div className="container-custom w-full max-w-6xl relative">
              <motion.div 
                className="relative rounded-2xl overflow-hidden backdrop-blur-lg border border-white/10"
        ...
        <PageIndicator 
          sections={[
            { id: 'intro-banner', name: 'Introduction' },
            { id: 'about-me', name: 'About Me' },
            { id: 'what-i-do', name: 'What I Do' },
