          ...
          <div className="sticky top-0 py-24 flex items-center justify-center min-h-screen">
            <div className="container-custom w-full max-w-6xl">
              ...
              >
                ...
                >
                  <motion.div
                    className="w-full h-[400px] rounded-xl shadow-2xl overflow-hidden relative bg-gray-900 border border-gray-700"
                  ...
                  >
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                      <motion.div 
                        className="bg-[#1E1E1E] w-[92%] h-[85%] rounded-lg p-6 shadow-lg relative overflow-hidden"
                    ...
                    {/* Remove floating gradient orbs for simpler design */}
                  </motion.div>
                </motion.div>
              </motion.div>
