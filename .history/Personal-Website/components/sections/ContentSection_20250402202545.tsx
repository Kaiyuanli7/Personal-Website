  ...
  return (
    <section ref={sectionRef} className="relative pt-0 pb-48 bg-gray-950">
      <div className="container-custom relative">
        ...
        <div ref={introBannerRef} className="min-h-screen mb-16">
          ...
          <div className="sticky top-0 py-24 flex items-center justify-center min-h-screen">
            <div className="container-custom w-full max-w-6xl relative">
              ...
              >
                ...
                {/* Decorative elements */}
                <motion.div 
                  className="absolute top-10 right-10 w-24 h-24 rounded-full bg-green-500/10 blur-xl"
                  animate={{ 
                    scale: [1, 1.3, 1],
                    opacity: [0.5, 0.7, 0.5]
                  }}
                ...
                />
                <motion.div 
                  className="absolute bottom-12 left-10 w-28 h-28 rounded-full bg-blue-500/10 blur-xl"
                  animate={{ 
                    scale: [1, 1.2, 1],
                    opacity: [0.5, 0.8, 0.5]
                  }}
