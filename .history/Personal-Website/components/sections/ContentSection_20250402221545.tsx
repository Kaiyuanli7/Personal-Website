  ...
  return (
    <section ref={sectionRef} className="relative pt-0 pb-48 bg-gray-950 scroll-smooth">
      <div className="container-custom relative">
        ...
        <div 
          ref={capabilitiesRef} 
          className="py-32 min-h-[300vh] snap-start scroll-mt-24"
        ...
        >
          <div className="sticky top-0 py-24 flex flex-col items-center justify-center min-h-screen overflow-hidden">
            <div className="container-custom w-full max-w-6xl relative">
              ...
              {/* Fluid capabilities layout */}
              <div className="relative w-full">
                <motion.div 
                  className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-6"
                  style={{
                    y: useTransform(capabilitiesProgress, [0, 1], [0, -50]),
                  }}
                >
                  {capabilities.map((capability, index) => (
                    ...
                    >
                      <motion.div
                        className="relative border border-white/10 p-2 rounded-2xl transition-all duration-300 hover:border-white/20 h-full"
                        whileHover={{ 
                          scale: 1.05,
                          rotateY: 5,
                          rotateX: -5,
                      ...
                      >
                        <GlowingEffect
                          ...
                          inactiveZone={0.01}
                        />
                        <div className="relative flex h-full flex-col justify-between overflow-hidden rounded-xl border-white/10 p-4 bg-black/40 backdrop-blur-sm">
                          {/* Animated gradient background */}
                          <motion.div 
                            className="absolute inset-0 opacity-20"
                            style={{
                              background: `linear-gradient(45deg, 
                                ${index % 3 === 0 ? 'rgba(147, 51, 234, 0.2)' : index % 3 === 1 ? 'rgba(59, 130, 246, 0.2)' : 'rgba(236, 72, 153, 0.2)'}, 
                                transparent)`,
                            }}
                            animate={{
                          ...
                          <div className="flex items-center space-x-3 mb-3">
                            <div className="rounded-lg border border-white/20 p-2 bg-white/5">
                              <span className="text-white/70">
                                {index % 4 === 0 ? <Code className="h-4 w-4" /> : 
                                 index % 4 === 1 ? <Laptop className="h-4 w-4" /> : 
                                 index % 4 === 2 ? <Sparkles className="h-4 w-4" /> : 
                                 <Box className="h-4 w-4" />}
                              </span>
                            </div>
                            <h3 className="text-md font-medium text-white font-body relative z-10">
                              {capability}
                            </h3>
                          </div>
                          ...
                          <motion.div 
                            className="h-1 bg-white/10 rounded-full overflow-hidden mt-auto"
                            initial={{ opacity: 0 }}
                          ...
                          >
                            <motion.div 
                              ...
                              style={{
                                backgroundColor: index % 3 === 0 ? 'rgb(147, 51, 234)' : index % 3 === 1 ? 'rgb(59, 130, 246)' : 'rgb(236, 72, 153)',
                                width: `${Math.min(75 + Math.random() * 25, 100)}%`
                              }}
                              initial={{ width: 0 }}
                              whileInView={{ width: `${Math.min(75 + Math.random() * 25, 100)}%` }}
                              viewport={{ once: true }}
                ...
                <motion.div 
                  className="absolute -top-20 -left-20 w-72 h-72 rounded-full bg-purple-500/5 blur-[80px] pointer-events-none"
                  animate={{ 
                    x: [0, 30, 0],
                    y: [0, -30, 0],
                    opacity: [0.3, 0.5, 0.3] 
                ...
                />
                <motion.div 
                  className="absolute -bottom-40 -right-20 w-80 h-80 rounded-full bg-blue-500/5 blur-[80px] pointer-events-none"
                  animate={{ 
                    x: [0, -30, 0],
                    y: [0, 30, 0],
                    opacity: [0.2, 0.4, 0.2] 
