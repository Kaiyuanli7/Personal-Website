    ...
    >
      <div style={{ height: `calc(${SECTION_HEIGHT}px + 100vh)` }} className="relative w-full">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center min-h-screen">
          ...
          >
            <Typewriter text="Kaiyuan Li" delay={0.2} speed={0.1} />
          </motion.h1>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            <Typewriter text="Senior High School Student | AI/ML Developer | Financial Analyst" delay={0.4} speed={0.05} />
          </motion.p>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
        ...
        >
          ...
          <div className="absolute inset-0 flex items-center justify-center z-10">
            ...
            >
              ...
              >
                <Typewriter text="Bridging Technology and Business" delay={0.2} speed={0.05} />
              </motion.h2>
              <motion.p 
