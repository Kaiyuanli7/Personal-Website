      ...
      <div className="container-custom relative">
        ...
        >
          <div className="sticky top-0 py-24 flex flex-col items-center justify-center min-h-screen overflow-hidden">
            <div className="container-custom w-full max-w-6xl relative">
              <div className="relative rounded-2xl overflow-hidden backdrop-blur-lg border border-white/10 mb-16 p-8">
                ...
                {/* Decorative elements */}
                <motion.div 
                  className="absolute top-4 right-4 w-24 h-24 rounded-full bg-purple-500/10 blur-xl"
                  animate={{ 
                    scale: [1, 1.2, 1],
                    opacity: [0.5, 0.8, 0.5]
                  }}
                ...
                />
                <motion.div 
                  className="absolute bottom-8 left-8 w-32 h-32 rounded-full bg-blue-500/10 blur-xl"
                  animate={{ 
                    scale: [1, 1.3, 1],
                    opacity: [0.5, 0.7, 0.5]
                  }}
              ...
              <div className="relative w-full overflow-hidden">
                ...
                >
                  {capabilities.map((capability, index) => (
                    <motion.div
                      key={capability}
                      className="relative overflow-hidden backdrop-blur-lg border border-white/10 rounded-2xl p-6 h-44 flex items-center justify-center flex-shrink-0 w-80"
                    ...
                    >
                      ...
                      <h3 className="text-xl font-medium text-white text-center font-body relative z-10">
                        {capability}
                      </h3>
                      
                      {/* Decorative orb in corner */}
                      <motion.div 
                        className="absolute bottom-3 right-3 w-16 h-16 rounded-full bg-blue-500/5 blur-lg"
                        animate={{ 
                          scale: [1, 1.2, 1],
                          opacity: [0.3, 0.5, 0.3]
                        }}
