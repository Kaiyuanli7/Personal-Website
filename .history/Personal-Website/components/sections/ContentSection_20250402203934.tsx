            ...
            <div className="container-custom w-full max-w-6xl relative">
              ...
              */}
              <motion.div
                ...
                initial={{ opacity: 1 }}
                style={{ 
                  opacity: useTransform(aboutMeProgress, [0, 0.07], [1, 0]),
                  filter: useTransform(aboutMeProgress, [0, 0.07], ["blur(0px)", "blur(20px)"]),
                  scale: useTransform(aboutMeProgress, [0, 0.07], [1, 1.5])
                }}
              >
              ...
              */}
              <motion.div 
                ...
                style={{ 
                  opacity: useTransform(aboutMeProgress, [0.05, 0.15, 0.45, 0.55], [0, 1, 1, 0]),
                  y: useTransform(aboutMeProgress, [0.05, 0.15, 0.45, 0.55], [50, 0, 0, -50]),
                  rotateX: useTransform(aboutMeProgress, [0.05, 0.15, 0.35, 0.45], [10, 0, 0, 10]),
                  rotateY: useTransform(aboutMeProgress, [0.15, 0.25, 0.35, 0.45], [-5, 0, 0, 5]),
                  scale: useTransform(aboutMeProgress, [0.05, 0.1, 0.4, 0.45], [0.9, 1, 1, 0.9]),
                  perspective: "1000px"
                }}
              >
              ...
              {/* 
                What I Do Section
                - Appears between scroll progress 0.35-0.45
                - Stays visible until 0.65-0.75
                - Current animation sequence:
                  0.35-0.45: Fade in and slide up
                  0.45-0.55: Rotate into position
                  0.55-0.6: Stay stable
                  0.6-0.65: Rotate out
                  0.65-0.75: Fade out and slide up
              */}
              <motion.div 
                className="relative -mt-32 rounded-2xl overflow-hidden backdrop-blur-lg border border-white/10"
                style={{ 
                  opacity: useTransform(aboutMeProgress, [0.35, 0.45, 0.65, 0.75], [0, 1, 1, 0]),
                  y: useTransform(aboutMeProgress, [0.35, 0.45, 0.65, 0.75], [100, 0, 0, -50]),
                  scale: useTransform(aboutMeProgress, [0.35, 0.4, 0.6, 0.65], [0.9, 1, 1, 0.9]),
                  rotateX: useTransform(aboutMeProgress, [0.35, 0.45, 0.55, 0.65], [10, 0, 0, -10])
                }}
              >
                ...
                <div className="grid md:grid-cols-[1fr_2fr] gap-6 p-8 relative z-10">
                  <div className="flex flex-col justify-center items-center md:items-end">
                    <motion.div 
                      ...
                      style={{
                        rotate: useTransform(aboutMeProgress, [0.4, 0.65], [-5, 5]),
                      }}
                    >
                      <div className="w-full h-full rounded-full bg-gray-900 flex items-center justify-center overflow-hidden">
                        <motion.div 
                          ...
                          style={{
                            scale: useTransform(aboutMeProgress, [0.45, 0.55], [0.9, 1]),
                          }}
                        >
                          WD
                        </motion.div>
                    ...
                    <motion.h3 
                      className="text-4xl font-bold text-white mt-6 font-display text-center md:text-right"
                      style={{
                        y: useTransform(aboutMeProgress, [0.4, 0.5], [20, 0]),
                        opacity: useTransform(aboutMeProgress, [0.4, 0.5], [0, 1]),
                      }}
                    >
                      What I Do
                    </motion.h3>
                    ...
                    <motion.div 
                      className="flex mt-4 gap-2 flex-wrap justify-center md:justify-end"
                      style={{
                        y: useTransform(aboutMeProgress, [0.45, 0.55], [20, 0]),
                        opacity: useTransform(aboutMeProgress, [0.45, 0.55], [0, 1]),
                      }}
                    >
                  ...
                  <div className="space-y-6">
                    <motion.div 
                      className="overflow-hidden rounded-xl bg-white/5 backdrop-blur-sm p-5 border border-white/10"
                      style={{
                        y: useTransform(aboutMeProgress, [0.4, 0.5], [30, 0]),
                        opacity: useTransform(aboutMeProgress, [0.4, 0.5], [0, 1]),
                        rotateY: useTransform(aboutMeProgress, [0.45, 0.55, 0.65], [-5, 0, 5]),
                      }}
                    >
                    ...
                    <motion.div 
                      className="overflow-hidden rounded-xl bg-white/5 backdrop-blur-sm p-5 border border-white/10"
                      style={{
                        y: useTransform(aboutMeProgress, [0.5, 0.6], [30, 0]),
                        opacity: useTransform(aboutMeProgress, [0.5, 0.6], [0, 1]),
                        rotateY: useTransform(aboutMeProgress, [0.55, 0.65], [5, -5]),
                      }}
                    >
              ...
              {/* 
                ...
                - First dot fades out at 0.35
                - Second dot fades in at 0.35
              ...
              */}
              <motion.div 
                ...
                style={{ 
                  opacity: useTransform(aboutMeProgress, [0.05, 0.15, 0.65, 0.75], [0, 1, 1, 0])
                }}
              >
                <motion.div 
                  className="w-10 h-2 rounded-full bg-white"
                  style={{ 
                    opacity: useTransform(aboutMeProgress, [0, 0.35], [1, 0.3]) 
                  }}
                />
                <motion.div 
                  className="w-10 h-2 rounded-full bg-white"
                  style={{ 
                    opacity: useTransform(aboutMeProgress, [0.35, 0.75], [0.3, 1]) 
                  }}
                />
              </motion.div>
            </div>
