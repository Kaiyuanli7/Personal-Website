            ...
            <div className="container-custom w-full max-w-6xl relative">
              ...
              */}
              ...
              {/* 
                ...
                - Current animation sequence:
                  ...
                  0.3-0.4: Stay stable
                  0.4-0.5: Rotate out
                  0.5-0.6: Fade out and slide up
              */}
              <motion.div 
                className="relative rounded-2xl overflow-hidden backdrop-blur-lg border border-white/10"
                style={{ 
                  opacity: useTransform(aboutMeProgress, [0.1, 0.2, 0.5, 0.6], [0, 1, 1, 0]),
                  y: useTransform(aboutMeProgress, [0.1, 0.2, 0.5, 0.6], [50, 0, 0, -50]),
                  rotateX: useTransform(aboutMeProgress, [0.1, 0.2, 0.4, 0.5], [10, 0, 0, 10]),
                  rotateY: useTransform(aboutMeProgress, [0.2, 0.3, 0.4, 0.5], [-5, 0, 0, 5]),
                  scale: useTransform(aboutMeProgress, [0.1, 0.15, 0.45, 0.5], [0.9, 1, 1, 0.9]),
                  perspective: "1000px"
                }}
              >
                ...
                <div className="grid md:grid-cols-[1fr_2fr] gap-6 p-8 relative z-10">
                  <div className="flex flex-col justify-center items-center md:items-end">
                    <motion.div 
                      ...
                      style={{
                        rotate: useTransform(aboutMeProgress, [0.15, 0.4], [-5, 5]),
                      }}
                    >
                    ...
                    <motion.div 
                      ...
                      style={{
                        y: useTransform(aboutMeProgress, [0.2, 0.3], [20, 0]),
                  ...
                  <div className="space-y-6">
                    <motion.div 
                      ...
                      style={{
                        y: useTransform(aboutMeProgress, [0.15, 0.25], [30, 0]),
                        opacity: useTransform(aboutMeProgress, [0.15, 0.25], [0, 1]),
                        rotateY: useTransform(aboutMeProgress, [0.2, 0.3, 0.4], [-5, 0, 5]),
                      }}
                    >
                    ...
                    <motion.div 
                      className="overflow-hidden rounded-xl bg-white/5 backdrop-blur-sm p-5 border border-white/10"
                      style={{
                        y: useTransform(aboutMeProgress, [0.25, 0.35], [30, 0]),
                        opacity: useTransform(aboutMeProgress, [0.25, 0.35], [0, 1]),
                        rotateY: useTransform(aboutMeProgress, [0.3, 0.4], [5, -5]),
                      }}
                    >
              ...
              {/* 
                What I Do Section
                - Appears between scroll progress 0.6-0.7
                - Stays visible until 0.9-1.0
                - Current animation sequence:
                  0.6-0.7: Fade in and slide up
                  0.7-0.8: Rotate into position
                  0.8-0.85: Stay stable
                  0.85-0.9: Rotate out
                  0.9-1.0: Fade out and slide up
              */}
              <motion.div 
                className="relative mt-6 rounded-2xl overflow-hidden backdrop-blur-lg border border-white/10"
                style={{ 
                  opacity: useTransform(aboutMeProgress, [0.6, 0.7, 0.9, 1], [0, 1, 1, 0]),
                  y: useTransform(aboutMeProgress, [0.6, 0.7, 0.9, 1], [50, 0, 0, -50]),
                  scale: useTransform(aboutMeProgress, [0.6, 0.65, 0.85, 0.9], [0.9, 1, 1, 0.9]),
                  rotateX: useTransform(aboutMeProgress, [0.6, 0.7, 0.8, 0.9], [10, 0, 0, -10])
                }}
              >
                {/* 
                  What I Do Title
                  - Appears between 0.65-0.75
                  - Adjust these values to change when the title appears
                */}
                <motion.h3 
                  className="text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-green-400 via-blue-500 to-purple-600 mb-8 font-display text-center"
                  style={{
                ...
                {/* 
                  Content Grid
                  - Appears between 0.7-0.8
                  - Adjust these values to change when the content appears
                */}
                <motion.div 
                ...
                {/* 
                  Skills Grid
                  - Appears between 0.75-0.85
                  - Adjust these values to change when the skills appear
                */}
                <motion.div 
                  className="mt-8 grid grid-cols-2 md:grid-cols-4 gap-4"
                  style={{
                    y: useTransform(aboutMeProgress, [0.75, 0.85], [30, 0]),
                    opacity: useTransform(aboutMeProgress, [0.75, 0.85], [0, 1]),
                  }}
                >
                  {[
                    { name: "Frontend", icon: "💻", color: "from-blue-400 to-blue-600" },
                    { name: "Backend", icon: "🔧", color: "from-green-400 to-green-600" },
                    { name: "AI/ML", icon: "🧠", color: "from-purple-400 to-purple-600" },
                    { name: "Business", icon: "📊", color: "from-yellow-400 to-yellow-600" }
                  ].map((skill, i) => (
                    <motion.div 
                      key={skill.name}
                      className="rounded-xl p-4 bg-white/5 backdrop-blur-sm border border-white/10 flex flex-col items-center justify-center"
                    ...
                    >
                      <div className={`w-12 h-12 rounded-full bg-gradient-to-br ${skill.color} flex items-center justify-center text-2xl mb-2`}>
                        {skill.icon}
                      </div>
              ...
              {/* 
                ...
                - First dot fades out at 0.6
                - Second dot fades in at 0.6
              ...
              */}
              <motion.div 
                ...
                style={{ 
                  opacity: useTransform(aboutMeProgress, [0.1, 0.2, 0.9, 1], [0, 1, 1, 0])
                }}
              >
                <motion.div 
                  className="w-10 h-2 rounded-full bg-white"
                  style={{ 
                    opacity: useTransform(aboutMeProgress, [0, 0.6], [1, 0.3]) 
                  }}
                />
                <motion.div 
                  className="w-10 h-2 rounded-full bg-white"
                  style={{ 
                    opacity: useTransform(aboutMeProgress, [0.6, 1], [0.3, 1]) 
                  }}
                />
              </motion.div>
            </div>
