...
export default function ContentSection() {
  ...
  return (
    <section ref={sectionRef} className="relative pt-0 pb-48 bg-gray-950">
      ...
      <div className="fixed right-8 top-1/2 transform -translate-y-1/2 z-50 flex flex-col gap-5 items-center">
        <div className="bg-white/10 backdrop-blur-md py-3 px-2 rounded-full flex flex-col gap-4">
          ...
          >
            <motion.div 
              className="w-2 h-14 bg-white/20 rounded-full overflow-hidden"
              style={{
                background: useTransform(
                  introBannerProgress, 
                  [0, 0.5, 1], 
                  ["linear-gradient(to top, rgba(255,255,255,0.8) 100%, rgba(255,255,255,0.2) 0%)", 
                   "linear-gradient(to top, rgba(255,255,255,0.8) 50%, rgba(255,255,255,0.2) 50%)", 
                   "linear-gradient(to top, rgba(255,255,255,0.8) 0%, rgba(255,255,255,0.2) 100%)"]
                )
              }}
            />
            <span className="absolute left-6 opacity-0 group-hover:opacity-100 transition-opacity text-white text-sm whitespace-nowrap bg-gray-800/80 backdrop-blur-sm px-2 py-1 rounded-md">
              Intro
            </span>
          </motion.button>
          ...
          {/* Capabilities section indicator */}
          <motion.button
            className="group relative flex items-center"
