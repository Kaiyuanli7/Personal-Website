...
export default function ContentSection() {
  ...
  return (
    <section ref={sectionRef} className="relative pt-0 pb-48 bg-gray-950">
      ...
      <motion.div 
        className="fixed right-8 top-1/2 -translate-y-1/2 z-50 py-6 px-3 rounded-full bg-gray-900/80 backdrop-blur-md border border-white/10 flex flex-col items-center space-y-8"
        initial={{ opacity: 0, x: 20 }}
        animate={{ opacity: 1, x: 0 }}
        transition={{ duration: 0.5 }}
      >
        <motion.button
          onClick={() => scrollToSection(introBannerRef)}
          className="flex flex-col items-center group"
          whileHover={{ scale: 1.05 }}
          whileTap={{ scale: 0.95 }}
        >
          <motion.div 
            className="w-3 h-3 rounded-full bg-white/50 group-hover:bg-white transition-colors duration-200"
            style={{ 
          ...
          />
          <span className="text-xs text-white/70 group-hover:text-white mt-1 whitespace-nowrap">Intro</span>
        </motion.button>
          ...
          <motion.div 
            ...
            style={{ 
              backgroundColor: useTransform(
                aboutMeProgress, 
                [0.2, 0.3, 0.4, 0.5], 
                ["rgba(255, 255, 255, 0.5)", "rgba(255, 255, 255, 0.9)", "rgba(255, 255, 255, 0.9)", "rgba(255, 255, 255, 0.5)"]
              ) 
            }}
          />
          <span className="text-xs text-white/70 group-hover:text-white mt-1 whitespace-nowrap">About Me</span>
        </motion.button>
        
        <motion.button
          onClick={() => scrollToSection(whatIDoRef)}
          className="flex flex-col items-center group"
          whileHover={{ scale: 1.05 }}
          whileTap={{ scale: 0.95 }}
        >
          ...
          />
          <span className="text-xs text-white/70 group-hover:text-white mt-1 whitespace-nowrap">What I Do</span>
        </motion.button>
        ...
        >
          ...
          />
          <span className="text-xs text-white/70 group-hover:text-white mt-1 whitespace-nowrap">Capabilities</span>
        </motion.button>
      </motion.div>
    </section>
  )
