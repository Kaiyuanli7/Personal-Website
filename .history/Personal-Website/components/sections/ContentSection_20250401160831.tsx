                    ...
                    <div className="overflow-hidden">
                      <motion.p 
                        ...
                        style={{
                          clipPath: "inset(0 0 0 0)",
                          WebkitClipPath: "inset(0 0 0 0)",
                          width: useTransform(aboutMeProgress, [0.83, 0.87], ["0%", "100%"])
                        }}
                      >
                        I've worked with tools like Hugging Face for machine learning, developed web applications using React.js, Node.js, and Expo, and used databases like MongoDB and PostgreSQL to store and manage data.
                      </motion.p>
                    </div>
                  </motion.div>
                </div>
