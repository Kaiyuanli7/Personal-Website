...
export default function ContentSection() {
  ...
  return (
    <section ref={sectionRef} className="relative pt-12 pb-48">
      ...
      <div className="absolute inset-0 -top-96 bg-gradient-to-b from-transparent via-gray-950/80 to-[#1E67C6]" />
      
      {/* Main content background with extended gradient */}
      <div className="absolute inset-0 -top-24 bg-gradient-to-b from-[#1E67C6] via-[#4A8FE7] to-[#87CEEB] rounded-[50px]">
        {/* Stars background with fade out effect */}
        ...
        <div className="absolute inset-0 rounded-[50px] bg-gradient-to-b from-transparent via-[#1E67C6]/10 to-[#87CEEB]/30" />
        <div className="absolute inset-0 rounded-[50px] bg-gradient-to-tr from-transparent via-white/5 to-transparent" />
      </div>
            ...
            <div className="container-custom w-full max-w-6xl">
              ...
              >
                ...
                <div className="space-y-8">
                  <h2 className="text-4xl font-bold text-white border-b-2 border-white/20 pb-4">
                    Professional Experience
                  </h2>
                  ...
                  <div className="space-y-12">
                    ...
                    >
                      <div className="md:w-1/3">
                        <h3 className="text-xl font-semibold text-white">Independent Stock Market Investor</h3>
                        <p className="text-blue-200 mt-1">2023 - Present</p>
                      </div>
                    ...
                    >
                      <div className="md:w-1/3">
                        <h3 className="text-xl font-semibold text-white">AI Tech Startup Intern</h3>
                        <p className="text-blue-200 mt-1">Phanta Field, 2023</p>
                      </div>
                      <div className="md:w-2/3">
                        <ul className="space-y-4 text-blue-100">
                          <li className="flex items-start">
                ...
                <div className="space-y-8">
                  ...
                  <div className="space-y-12">
                    ...
                    >
                      <div className="md:w-1/3">
                        <h3 className="text-xl font-semibold text-white">Archbishop Mitty High School</h3>
                        <p className="text-blue-200 mt-1">2021 - 2025</p>
                      </div>
                      <div className="md:w-2/3">
                        <p className="text-blue-100">San Jose, CA</p>
                        <p className="text-blue-200 mt-2">Senior, Expected Graduation: 2025</p>
                      </div>
                    </motion.div>
                    ...
                    >
                      <div className="md:w-1/3">
                        <h3 className="text-xl font-semibold text-white">Northeastern University</h3>
                        <p className="text-blue-200 mt-1">2025 - 2029</p>
                      </div>
                      <div className="md:w-2/3">
                        <p className="text-blue-100">Boston, MA</p>
                        <p className="text-blue-200 mt-2">Incoming Freshman, Fall 2025</p>
                        <p className="text-blue-100 mt-2">Combined Major: Business and Computer Science</p>
                      </div>
                    </motion.div>
                  </div>
                </div>
                ...
                <div className="space-y-8">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
                    ...
                    >
                      ...
                      <p className="text-blue-200 mt-2">Native</p>
                    </motion.div>
                    ...
                    <motion.div 
                      ...
                      className="text-center"
                    >
                      <h3 className="text-xl font-semibold text-white">Chinese (Mandarin)</h3>
                      <p className="text-blue-200 mt-2">Fluent</p>
                    </motion.div>
                    ...
                    <motion.div 
                      ...
                      className="text-center"
                    >
                      <h3 className="text-xl font-semibold text-white">Cantonese</h3>
                      <p className="text-blue-200 mt-2">Beginner</p>
                    </motion.div>
                  </div>
                </div>
              </motion.div>
