...
export default function ContentSection() {
  ...
  return (
    <section ref={sectionRef} className="relative pt-0 pb-48 bg-gray-950">
      ...
      <motion.div 
        className="fixed bottom-8 left-1/2 -translate-x-1/2 z-50 px-6 py-3 rounded-full bg-gray-900/80 backdrop-blur-md border border-white/10 flex items-center space-x-4"
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
