                ...
                <div className="w-3/5 relative">
                  ...
                  >
                    <div className="overflow-hidden">
                      ...
                      >
                        <Typewriter 
                          text="Hey, I'm Kaiyuan Li, a senior from San Jose, California, with a passion for tech, business, and creativity. I'll be heading to Northeastern University this fall to study Business and Computer Science."
                          delay={0.2}
                          speed={0.03}
                        />
                      </motion.p>
                    ...
                    <div className="overflow-hidden">
                      ...
                      >
                        <Typewriter 
                          text="Outside of my academic work, I'm into music, gaming, and cooking. I play drums in my school's Wind Ensemble, perform at local events, and also love to unwind by gaming—ranked nationally in a few games! When I'm not immersed in tech, I enjoy experimenting in the kitchen and trying out new recipes."
                          delay={0.4}
                          speed={0.03}
                        />
                      </motion.p>
              ...
              >
                ...
                <div className="w-3/5 relative pl-8">
                  ...
                  <div className="overflow-hidden">
                    ...
                    >
                      <Typewriter 
                        text="I'm all about using technology to solve problems and bring ideas to life. I've developed a strong skill set in programming, primarily with Python, Java, and JavaScript."
                        delay={0.2}
                        speed={0.03}
                      />
                    </motion.p>
                  ...
                  <div className="overflow-hidden">
                    ...
                    >
                      <li className="flex items-start">
                        ...
                        <Typewriter text="Built a song recommendation system using the Spotify and Cyanite APIs" delay={0.4} speed={0.03} />
                      </li>
                      <li className="flex items-start">
                        <span className="mr-2">•</span>
                        <Typewriter text="Led teams to develop a web app for AI-generated pickup lines" delay={0.6} speed={0.03} />
                      </li>
                      <li className="flex items-start">
                        <span className="mr-2">•</span>
                        <Typewriter text="Helped launch an image generation app for an AI startup" delay={0.8} speed={0.03} />
                      </li>
                      <li className="flex items-start">
                        <span className="mr-2">•</span>
                        <Typewriter text="Applied technical analysis tools to grow my personal investment portfolio" delay={1.0} speed={0.03} />
                      </li>
                    </motion.ul>
                  </div>
                </div>
