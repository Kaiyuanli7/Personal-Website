...
export default function PageTransition({ children }: { children: React.ReactNode }) {
  ...
  }, [isTransitioning, children, newChildrenKey])

  // Create wrapped children with key to preserve instance
      ...
      {isTransitioning ? (
        <div className="relative w-full h-full">
          ...
          {/* New content - will be progressively revealed by the mask 
              We use the same key here as when we set displayChildren to preserve component instances */}
          <div 
