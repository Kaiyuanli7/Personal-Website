    ...
    >
      ...
      {isVisible && (
        <div className="flex flex-col gap-4">
          <div className="relative rounded-full border border-white/10 p-1 transition-all duration-300 hover:border-white/20">
            <GlowingEffect
              spread={40}
              glow={true}
              disabled={false}
            ...
            <Link 
              ...
              className="w-12 h-12 bg-black/40 backdrop-blur-sm rounded-full flex items-center justify-center transition-all duration-300 hover:scale-110 active:scale-95 relative"
